                    ...
                    <div class="card-body">
                      ...
                      <form action="insert.php" method="POST">
                        <div class="form-floating form-floating-outline mb-6">
                          <input type="number" name="studentNumber" class="form-control" id="studentNumber" placeholder="220293" required/>
                          <label for="studentNumber">Student Number</label>
                        </div>
                        <div class="form-floating form-floating-outline mb-6">
                          <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Dela Cruz" />
                          <label for="lastname">Lastname</label>
                        </div>
                        <div class="form-floating form-floating-outline mb-6">
                          <input type="text" name="firstname" class="form-control" id="firstname" placeholder="Pedro" />
